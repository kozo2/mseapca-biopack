...
#'
#' This function performs over-representation analysis (ORA) by enumerating all possible patterns 
#' of significant and non-significant assignments among undetected metabolites for each metabolite 
#' set. It returns the minimum, median, and maximum p-values from Fisher's exact tests across these 
#' patterns, thereby estimating the full uncertainty range due to undetected metabolites.
#'
...
#' @param M A named list of metabolite sets, where each element is a character vector of 
#'   metabolite IDs.
#'
...
#' The function then considers all possible numbers of significant metabolites (from 0 to the 
#' total number of undetected ones) among those undetected.
